/*
	Title: 		whileExample_4.cpp
	Author: 	Gaddis, modified by April R Crockett
	Date: 		February 9, 2009
	Purpose:  	This program calculates the number of soccer teams
...
int main()
{
	...
	while (teamPlayers < MIN_PLAYERS || teamPlayers > MAX_PLAYERS)
	{
		...
		cout << " but no more than " << MAX_PLAYERS << " per team.\n";
