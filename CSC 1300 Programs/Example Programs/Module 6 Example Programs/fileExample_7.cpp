/*
	Title:  fileExample_7.cpp
	Author:  April R Crockett
	Date:  7/27/2017
	Purpose:  output file example that writes user input to a file.
*/
...
int main()
{
   fstream outputFile;  // File stream object
   ...
   outputFile.open("Sales.txt", ios::out);
