...
template<typename T>
void getData(T scores[], int size)
{
	// Loop counter
	int index;
...
template<typename T>
T getTotal(const T array[], int size)
{
...
template<typename T>
T getLowest(const T array[], int size)
{
	T lowest;  // To hold the lowest value
...
template<typename T>
T getHighest(const T array[], int size)
{
	T highest;  // To hold the highest value
